...
class PermissionService {
  ...
  Future<bool> isCameraDeniedPermanently() async => await Permission.camera.isPermanentlyDenied;

  Future<bool> isMicrophoneDeniedPermanently() async => await Permission.microphone.isPermanentlyDenied;
